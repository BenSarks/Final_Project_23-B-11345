...
private MaterialTextView sender_Name, delivery_Method, package_Id,order_Date,package_Status,delivery_Date;
    ...
    private void init(){
        ...
        this.delivery_Date = binding.textviewDeliveryDate;
    }
